...
WINDOW 3 24 29 Left 2
SYMATTR Value MNMDI
SYMATTR SpiceLine l=1u w=4u pd=w+l+l ps=pd ad=w*l as=ad m=1
SYMATTR Prefix X
SYMATTR Description N-Channel Isolated Depletion MOSFET
PIN 16 -48 TOP 2
PINATTR PinName D
